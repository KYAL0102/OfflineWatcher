...
public partial class SeriesContentControl : UserControl
{
    private SeriesContentViewModel _viewModel;
    public SeriesContentControl()
    {
        InitializeComponent();
        _viewModel = new SeriesContentViewModel();
